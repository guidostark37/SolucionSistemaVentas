...
namespace sistemaVentas.datos.dbContext;
...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CB57A9597");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FD410A066");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4839CEC38E0");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1074A0DFB11");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EB9B332B6");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1327BBFCAF8");
            ...
            entity.HasOne(d => d.IdCategoriaNavigation).WithMany(p => p.Productos)
                ...
                .HasConstraintName("FK__Producto__idCate__66603565");
        });

        modelBuilder.Entity<Rol>(entity =>
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76F58B186F");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D86FE584E2");
            ...
            entity.HasOne(d => d.IdMenuNavigation).WithMany(p => p.RolMenus)
                ...
                .HasConstraintName("FK__RolMenu__idMenu__5BE2A6F2");

            entity.HasOne(d => d.IdRolNavigation).WithMany(p => p.RolMenus)
                .HasForeignKey(d => d.IdRol)
                .HasConstraintName("FK__RolMenu__idRol__5AEE82B9");
        });

        modelBuilder.Entity<TipoDocumentoVenta>(entity =>
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEFDA7E12B");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A67ADE167B");
            ...
            entity.HasOne(d => d.IdRolNavigation).WithMany(p => p.Usuarios)
                .HasForeignKey(d => d.IdRol)
                .HasConstraintName("FK__Usuario__idRol__5FB337D6");
        });

        modelBuilder.Entity<Venta>(entity =>
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614CE014AB9");
            ...
            entity.HasOne(d => d.IdTipoDocumentoVentaNavigation).WithMany(p => p.Venta)
                ...
                .HasConstraintName("FK__Venta__idTipoDoc__6EF57B66");
